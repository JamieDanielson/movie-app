module.exports = {
  ...
  rules: {
    ...
    // allow dangling _id for mongoose and mvom
    'no-underscore-dangle': ['error', { allow: ['_id', '__v', '_raw'] }],
  ...
  overrides: [
    {
      files: ['*.ts'],
      rules: {
        // allow duplicate class members for function overloads
    ...
    },
    {
      ...
      rules: {
        // in index, constants, schemas, and type files, always use named exports
